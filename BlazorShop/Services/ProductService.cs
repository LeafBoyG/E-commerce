...
namespace BlazorShop.Services
{
    public class ProductService
    {
        ...
        {
            new Product { Id = 1, Name = "Louis Vuitton Bag", Price = 4500.00m, ImageUrl = "images/gucci.png", Category = "Fashion" },
            new Product { Id = 2, Name = "Face Cream", Price = 300.00m, ImageUrl = "images/cream.png", Category = "Beauty" },
            new Product { Id = 3, Name = "DSLR Camera", Price = 3500.00m, ImageUrl = "images/camera.png", Category = "Electronics" },
